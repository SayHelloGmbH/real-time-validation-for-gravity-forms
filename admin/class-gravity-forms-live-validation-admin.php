...
?> <form method="POST"> <?php wp_nonce_field('gforms_update_settings', 'gforms_update_settings') ?>
                            ...
                            if (in_array(rgar($field, 'type'), $this->lv_supported_fields_for_presence) && rgar($field, 'isRequired')) {
                                ...
                                if (in_array(rgar($field, 'type'), $this->lv_has_sub_fields)) {
                                    ...
                                    $f['lv_validation'] = array(
                                        array(
                                            array('type' => 'presence', 'ftype' => $this->get_presence_ftype(rgar($field, 'type')))
                                        )
                                    );
                                }
                            }
            ...
            <script type="text/javascript">
                var is_RealTimeValidOn = <?php echo ($this->lv_is_enabled) ? "true" : "false"; ?>;
            </script>


            <script type="text/javascript">
                var lv_default_error_messages = '<?php echo json_encode(apply_filters('lv_default_error_messages', $default_messages)); ?>';
            </script>
        ...
        ?>
            ...
            <script>
                jQuery(window).load(function() {
                    ...
                    jQuery(".row-actions").css({
                        "left": "0px"
                    });
                    jQuery(".lv_addon_help").css({
