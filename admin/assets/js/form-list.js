(function ($) {
    ...
    $(function () {
        var page_column_header =
            '<th scope="col" id="gf_util_page" class="manage-column column-title">Real Time Validation</th>';
        ...
        jQuery.each(forms_list, function () {
            ...
            page_links =
                '<input class="lv_validation_default_formlist_checkboxes" onchange ="toggleRvState(' +
                form_id +
                ',this);" type="checkbox" ' +
                str +
                "/>";
