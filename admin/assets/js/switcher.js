...
(function ($, undefined) {
    ...
    jQuery.extend(Plugin.prototype, {
        ...
        setValue: function (val) {
            ...
            if (val === null) {
                if ($input.attr("type") == "radio") {
                    val =
                        typeof $input.filter(":checked").val() !== "undefined";
                } else {
            ...
            if (typeof val != "boolean") {
                return console.log(
                    "The parameter need to be true or false as a boolean"
                );
            }
            ...
            if ($input.attr("type") == "radio") {
                ...
                var $containerGroup = $inputGroup.parent(
                    "." + self.settings.className
                );
    ...
    jQuery.each(["left", "up", "down", "right"], function () {
        jQuery.event.special["swipe" + this] = {
            setup: function () {
